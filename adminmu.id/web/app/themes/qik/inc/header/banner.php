						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_main">
								...
								<?php else : ?>
									...
									<?php } else { ?>
									<p class="title">
										<?php echo esc_html__( 'Events', 'qik' ); ?>
									</p>
									<?php } ?>
								...
								<?php if ( is_category() ) : ?>
									<p class="title">
										...
										printf(
											...
											esc_html__( 'Category Archives: %s', 'qik' ),
								...
								<?php elseif ( is_archive() ) : ?>
									<p class="title">
										...
										if ( is_day() ) :
											printf(
												// translators: Date.
												esc_html__( 'Daily Archives: %s', 'qik' ),
												get_the_date()
											);
										elseif ( is_month() ) :
											printf(
												// translators: Month and Date.
												esc_html__( 'Monthly Archives: %s', 'qik' ),
												get_the_date( _x( 'F Y', 'monthly archives date format', 'qik' ) )
											);
										elseif ( is_year() ) :
											printf(
												// translators: Month Date, Year.
												esc_html__( 'Yearly Archives: %s', 'qik' ),
												get_the_date( _x( 'Y', 'yearly archives date format', 'qik' ) )
											);
										else :
											esc_html__( 'Archives', 'qik' );
										endif;
										?>
									</p>
								<?php else : ?>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_main">
								...
								<?php else : ?>
									...
									<?php } else { ?>
									<p class="title">
										<?php echo esc_html__( 'Search', 'qik' ); ?>
									</p>
									<?php } ?>
