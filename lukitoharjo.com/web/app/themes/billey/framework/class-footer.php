...
if ( ! class_exists( 'Billey_Footer' ) ) {
	...
	class Billey_Footer {
		...
		function mobile_menu_logo() {
			$mobile_logo = Billey::setting( 'mobile_menu_logo' );
			$logo_width  = Billey::setting( 'mobile_logo_width' );

			if ( isset( $mobile_logo['id'] ) ) {
				$logo_url = Billey_Image::get_attachment_url_by_id( array(
					'id'   => $mobile_logo['id'],
			...
			<div id="page-off-sidebar" class="page-off-sidebar">
				<div class="inner">
					...
					<div class="page-off-sidebar-content">
						<?php Billey_Templates::generated_sidebar( 'off_sidebar' ); ?>
					</div>
				</div>
			</div>
			<?php
			...
			<div id="page-mobile-main-menu" class="page-mobile-main-menu">
				<div class="inner">
					...
					<div class="page-mobile-menu-content">
						<?php Billey::menu_mobile_primary(); ?>
					</div>
				</div>
			</div>
			<?php
		...
		function scroll_top() {
			?>
			<?php if ( Billey::setting( 'scroll_top_enable' ) ) : ?>
	...
	Billey_Footer::instance()->initialize();
}
