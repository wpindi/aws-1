...
if ( ! class_exists( 'Billey_Performance' ) ) {
	class Billey_Performance {
		...
		function disable_emojis() {
			$enable = Billey::setting( 'disable_emoji' );
			if ( ! $enable ) {
				return;
			}
		...
		function disable_embeds_code_init() {
			$enable = Billey::setting( 'disable_embeds' );
			if ( ! $enable ) {
				return;
			}
	...
	Billey_Performance::instance()->initialize();
}
