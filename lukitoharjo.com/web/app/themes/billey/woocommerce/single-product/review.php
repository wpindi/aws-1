...
?>
<li itemprop="review" itemscope itemtype="http://schema.org/Review" <?php comment_class( 'comment' ); ?>
		...
		<div class="comment-content">
			...
			<div class="comment-footer">
				<time class="woocommerce-review__published-date comment-datetime"
					...
					<?php
					printf( '%s %s %s', get_comment_date(), esc_html__( 'at', 'billey' ), get_comment_time() );
					?>
				</time>
