...
class Modify_Widget_Section extends Modify_Base {
	...
	public function section_layout( $element ) {
		...
		$section_gap['options'] = [
			...
			'default'  => esc_html__( 'Normal', 'billey' ),
			'no'       => esc_html__( 'No Gap', 'billey' ),
			'narrow'   => esc_html__( 'Narrow', 'billey' ),
			'extended' => esc_html__( 'Extended', 'billey' ),
			'wide'     => esc_html__( 'Wide', 'billey' ),
			'wider'    => esc_html__( 'Wider', 'billey' ),
		...
		$element->add_control( 'gap_beside', [
			'label'        => esc_html__( 'Gap Beside', 'billey' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'yes',
			'options'      => [
				'no'  => esc_html__( 'No', 'billey' ),
				'yes' => esc_html__( 'Yes', 'billey' ),
			],
		...
		$element->add_responsive_control( 'gap_width', [
			'label'     => esc_html__( 'Gap Width', 'billey' ),
		...
		$element->add_control( 'column_vertical_alignment', [
			'label'                => esc_html__( 'Column Vertical Alignment', 'billey' ),
			'label_block'          => true,
			'type'                 => Controls_Manager::CHOOSE,
		...
		$element->add_control( 'column_hover_high_zindex', [
			'label'        => esc_html__( 'High Z-Index on hover columns?', 'billey' ),
			'label_block'  => false,
			'type'         => Controls_Manager::SWITCHER,
			'prefix_class' => 'elementor-section-columns-hover-',
			'return_value' => 'high-z-index',
		] );
