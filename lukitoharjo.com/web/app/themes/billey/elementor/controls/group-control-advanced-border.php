...
class Group_Control_Advanced_Border extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['type'] = [
			'label'     => _x( 'Type', 'Border Control', 'billey' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
				''       => __( 'Default', 'billey' ),
				'none'   => __( 'None', 'billey' ),
				'solid'  => _x( 'Solid', 'Border Control', 'billey' ),
				'double' => _x( 'Double', 'Border Control', 'billey' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'billey' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'billey' ),
				'groove' => _x( 'Groove', 'Border Control', 'billey' ),
			],
			'selectors' => [
		...
		$fields['color'] = [
			'label'     => _x( 'Color', 'Border Control', 'billey' ),
		...
		$fields['width'] = [
			'label'      => _x( 'Width', 'Border Control', 'billey' ),
		...
		$fields['radius'] = [
			'label'      => _x( 'Rounded', 'Border Control', 'billey' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x( 'Border', 'Advanced Border Control', 'billey' ),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
