...
class Group_Control_Text_Gradient extends Group_Control_Base {
	...
	private static function get_default_color_types() {
		return [
			'classic'  => [
				'title' => _x( 'Classic', 'Text Gradient Control', 'billey' ),
				'icon'  => 'eicon-paint-brush',
			],
			'gradient' => [
				'title' => _x( 'Gradient', 'Text Gradient Control', 'billey' ),
				'icon'  => 'eicon-barcode',
			],
		];
	}
	...
	public function init_fields() {
		...
		$fields['color_a'] = [
			'label'       => esc_html__( 'First Color', 'billey' ),
			'type'        => Controls_Manager::COLOR,
			'default'     => '#5758DF',
			'render_type' => 'ui',
			'condition'   => [
		...
		$fields['color_a_stop'] = [
			'label'       => _x( 'Location', 'Text Gradient Control', 'billey' ),
		...
		$fields['gradient_angle'] = [
			'label'      => _x( 'Angle', 'Text Gradient Control', 'billey' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [ 'deg' ],
			'default'    => [
				'unit' => 'deg',
